...
public class Constants {
    ...
    static final float SERVO_SCORING_POS_RECEIVE = .53f;
    static final float SERVO_SCORING_POS_SCORE = .9f;
    static final float SERVO_INTAKE_ANGLE_POS_INIT = 0;
    static final float SERVO_INTAKE_ANGLE_POS_INTAKE = .42f;
    static final float SERVO_INTAKE_ANGLE_POS_CRATER = .67f;
