...
public class Constants {
    ...
    static final float SERVO_INTAKE_HOLDER_POS_HOLD = 0;    // TODO: find actual position
    static final float SERVO_INTAKE_HOLDER_POS_DEPOSIT = 1;    // TODO: find actual position
